...
namespace QAT_Project
{
    public partial class Form2 : Form
    {
        ...
        {
            CondAct.Add("Username*F,Password*F", "Output Page*E");
            CondAct.Add("Username*T,Password*F", "Output Page*E");
            CondAct.Add("Username*F,Password*T", "Output Page*E");
            CondAct.Add("Username*T,Password*T", "Output Page*H");
        }
